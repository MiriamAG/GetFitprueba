...
public class GetCaloriesAsyncTask extends AsyncTask<Void, Void, Void> {
    ...
    int total ;
    Float expendedCalories;

    GetCaloriesAsyncTask(DataReadRequest dataReadRequest_, GoogleApiClient googleApiClient) {
    ...
    protected Void doInBackground(Void... params) {
        DataReadResult   dataReadResult = Fitness.HistoryApi.readData(mClient, readRequest).await(30, TimeUnit.SECONDS);
